  ...
  return (
    <aside className="h-screen md:fixed md:bg-[var(--color-white)] md:w-[15rem] md:z-[3] md:shadow-[1rem_3rem_4rem_var(--color-light)] md:h-screen md:left-[-100%] md:hidden md:animate-showMenu">
      ...
      <div className="flex flex-col bg-[var(--color-white)] shadow-[var(--box-shadow)] rounded-[15px] h-[88vh] relative top-6 duration-300 ease delay-0 hover:shadow-[none]">
        <a
          href="#"
          className="flex items-center text-[var(--color-info-dark)] h-[3.7rem] gap-4 relative ml-8 duration-300 ease delay-0 hover:text-[var(--color-primary)] xl:w-[5.6rem] md:w-full md:h-[3.4rem]"
        >
          <BiSolidDashboard className="text-[1.6rem] duration-300 ease delay-0 group-hover:ml-[0.6rem]" />
          <h3 className="xl:hidden md:inline">Dashboard</h3>
        </a>
        <a
          href="#"
          className="flex items-center text-[var(--color-info-dark)] h-[3.7rem] gap-4 relative ml-8 duration-300 ease delay-0 hover:text-[var(--color-primary)] xl:w-[5.6rem] md:w-full md:h-[3.4rem]"
        >
          ...
          <h3 className="xl:hidden md:inline">Users</h3>
        </a>
        <a
          href="#"
          className="flex items-center text-[var(--color-info-dark)] h-[3.7rem] gap-4 relative ml-8 duration-300 ease delay-0 hover:text-[var(--color-primary)] xl:w-[5.6rem] md:w-full md:h-[3.4rem]"
        >
          ...
          <h3 className="xl:hidden md:inline">History</h3>
        </a>
        <a
          href="#"
          className="flex items-center h-[3.7rem] gap-4 relative duration-300 ease delay-0 hover:text-[var(--color-primary)] xl:w-[5.6rem] md:w-full md:h-[3.4rem] w-full text-[var(--color-frimary)] bg-[var(--color-light)] ml-0 before:contents before:w-1.5 before:h-[18px] before:bg-[var(--color-primary)]"
        >
          <MdOutlineInsights className="text-[1.6rem] duration-300 ease delay-0 group-hover:ml-[0.6rem] text-[var(--color-primary)] ml-[calc(1rem - 3px)]" />
          <h3 className="xl:hidden md:inline">Analytics</h3>
        </a>
        <a
          href="#"
          className="flex items-center text-[var(--color-info-dark)] h-[3.7rem] gap-4 relative ml-8 duration-300 ease delay-0 hover:text-[var(--color-primary)] xl:w-[5.6rem] md:w-full md:h-[3.4rem]"
        >
          ...
          <h3 className="xl:hidden md:inline">Tickets</h3>
        ...
        >
          ...
          <h3 className="xl:hidden md:inline">Sale List</h3>
        </a>
        <a
          href="#"
          className="flex items-center text-[var(--color-info-dark)] h-[3.7rem] gap-4 relative ml-8 duration-300 ease delay-0 hover:text-[var(--color-primary)] xl:w-[5.6rem] md:w-full md:h-[3.4rem]"
        >
          ...
          <h3 className="xl:hidden md:inline">Reports</h3>
        </a>
        <a
          href="#"
          className="flex items-center text-[var(--color-info-dark)] h-[3.7rem] gap-4 relative ml-8 duration-300 ease delay-0 hover:text-[var(--color-primary)] xl:w-[5.6rem] md:w-full md:h-[3.4rem]"
        >
          ...
          <h3 className="xl:hidden md:inline">Settings</h3>
        </a>
        <a
          href="#"
          className="flex items-center text-[var(--color-info-dark)] h-[3.7rem] gap-4 relative ml-8 duration-300 ease delay-0 hover:text-[var(--color-primary)] xl:w-[5.6rem] md:w-full md:h-[3.4rem]"
        >
          ...
          <h3 className="xl:hidden md:inline">New Login</h3>
        </a>
        <a
          href="#"
          className="flex items-center text-[var(--color-info-dark)] h-[3.7rem] gap-4 absolute bottom-8 w-full ml-8 duration-300 ease delay-0 hover:text-[var(--color-primary)] xl:w-[5.6rem] xl:relative xl:mt-[1.8rem] md:w-full md:h-[3.4rem] md:absolute md:bottom-20"
        >
          <MdLogout className="text-[1.6rem] duration-300 ease delay-0 group-hover:ml-[0.6rem]" />
          <h3 className="xl:hidden md:inline">Logout</h3>
        </a>
      </div>
    </aside>
  );
